defmodule BhramaWeb.ChatbotLive do
  ...
  def mount(_params, _session, socket) do
    # For this Bhrama, we are only working with a single conversation
    conversation =
  ...
  def handle_info({BhramaWeb.ChatbotLive.FormComponent, {:saved, message}}, socket) do
    ...
    Task.async(fn ->
      Chatbot.generate_response(socket.assigns.conversation, messages, class: "5th grade")
    end)
